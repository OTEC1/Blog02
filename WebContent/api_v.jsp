...
statement=connection.prepareStatement(new User_algorithm_check().api_v(a1));
...
<br/> <br/> 
<h5 id="style-1"><b  class="white">Title: <%=resultSet.getString(3) %></b></h5>    
...
<div class="relation">
<br/>
&nbsp;<b  style="background: #fff">Related Video's</b>
</div>
...
<%
String  a2= request.getParameter("cats");
try{
connection =  new Connection_sql().getConnection();
statement=connection.prepareStatement(new User_algorithm_check()
		           .member_check(a2,connection,statement,"Vid_path","Read more"));
resultSet = statement.executeQuery();
while(resultSet.next()){
%>
...
<a   href="api_v.jsp?id=<%=resultSet.getString(1)%>&cats=<%=a2%>">
<img alt="	<%=resultSet.getString(3) %>"  
src="<%=url.concat(resultSet.getString(2))%>"  class="tumb"/>
</a>
<p  class="p_write">
